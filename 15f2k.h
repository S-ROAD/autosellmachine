...
sbit PT0        =   IP^1;
sbit PX0        =   IP^0;
sfr IE2         =   0xAF;   //0000,0000 
sfr IP2         =   0xB5;   //xxxx,xx00 
sfr INT_CLKO    =   0x8F;   //0000,0000 


sfr TCON        =   0x88;   //0000,0000 
sbit TF1        =   TCON^7;
sbit TR1        =   TCON^6;
sbit TF0        =   TCON^5;
sbit TR0        =   TCON^4;
...
sbit IE0        =   TCON^1;
sbit IT0        =   TCON^0;
sfr TMOD        =   0x89;   //0000,0000 
sfr TL0         =   0x8A;   //0000,0000 
sfr TL1         =   0x8B;   //0000,0000 
sfr TH0         =   0x8C;   //0000,0000 
sfr TH1         =   0x8D;   //0000,0000 
sfr T4T3M       =   0xD1;   //0000,0000 
sfr T3T4M       =   0xD1;   //0000,0000 
sfr T4H         =   0xD2;   //0000,0000 
sfr T4L         =   0xD3;   //0000,0000 
sfr T3H         =   0xD4;   //0000,0000 
sfr T3L         =   0xD5;   //0000,0000 
sfr T2H         =   0xD6;   //0000,0000 
sfr T2L         =   0xD7;   //0000,0000 
sfr WKTCL       =   0xAA;   //0000,0000 
sfr WKTCH       =   0xAB;   //0000,0000 
sfr WDT_CONTR   =   0xC1;   //0000,0000 


sfr SCON        =   0x98;   //0000,0000 
sbit SM0        =   SCON^7;
sbit SM1        =   SCON^6;
sbit SM2        =   SCON^5;
sbit REN        =   SCON^4;
...
sfr S2CON       =   0x9A;   //0000,0000 
sfr S2BUF       =   0x9B;   //xxxx,xxxx 
sfr S3CON       =   0xAC;   //0000,0000 
sfr S3BUF       =   0xAD;   //xxxx,xxxx 
sfr S4CON       =   0x84;   //0000,0000 
sfr S4BUF       =   0x85;   //xxxx,xxxx 
sfr SADDR       =   0xA9;   //0000,0000 
sfr SADEN       =   0xB9;   //0000,0000 

//ADC 
sfr ADC_CONTR   =   0xBC;   //0000,0000 
sfr ADC_RES     =   0xBD;   //0000,0000 
sfr ADC_RESL    =   0xBE;   //0000,0000 

//SPI 
sfr SPSTAT      =   0xCD;   //00xx,xxxx 
sfr SPCTL       =   0xCE;   //0000,0100 
sfr SPDAT       =   0xCF;   //0000,0000 


sfr IAP_DATA    =   0xC2;   //0000,0000 
sfr IAP_ADDRH   =   0xC3;   //0000,0000 
sfr IAP_ADDRL   =   0xC4;   //0000,0000 
sfr IAP_CMD     =   0xC5;   //xxxx,xx00 
sfr IAP_TRIG    =   0xC6;   //0000,0000 
sfr IAP_CONTR   =   0xC7;   //0000,x000 


sfr CCON        =   0xD8;   //00xx,xx00 
sbit CF         =   CCON^7;
sbit CR         =   CCON^6;
sbit CCF2       =   CCON^2;
sbit CCF1       =   CCON^1;
...
sfr CCAPM0      =   0xDA;   //0000,0000 
sfr CCAPM1      =   0xDB;   //0000,0000 
sfr CCAPM2      =   0xDC;   //0000,0000 
...
sfr CMPCR1      =   0xE6;   //0000,0000 
sfr CMPCR2      =   0xE7;   //0000,0000 

sfr PWMCFG      =   0xf1;   //x000,0000 
sfr PWMCR       =   0xf5;   //0000,0000 
sfr PWMIF       =   0xf6;   //x000,0000 
sfr PWMFDCR     =   0xf7;   //xx00,0000 
